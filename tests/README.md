...
**纯 Python 标准库，无容器、无网络、无真实数据，约 5 秒跑完 148 个用例。**
...
1. `./run_tests.sh` —— 148 用例全绿（验证 Python 版本兼容与全部纯逻辑）
