...
| `test_alerts.py` | **P0/P1/P2 三级判定**（v2.9.0 DEC-21：质量阈值全量 P2、NTC 污染 P1、mapped<90 P1 报错不中断）、最差级别、里程碑模板字段、产物摘要 | 分级体系：P0=阻断中断 / P1=严重不中断 / P2=质量提示；NTC 污染曾为 P0（RUN-33 降级锚） |
